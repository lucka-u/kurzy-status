...
<div class="badge">poslední trénink: ${escapeHtml(formatDateCz(lastTue))}</div>
</div>
${renderMeta(tueItems)}
</article>
...
<div class="badge">poslední trénink: ${escapeHtml(formatDateCz(lastThu))}</div>
</div>
${renderMeta(thuItems)}
</article>
</section>
...
function main() {
  ...
  const html = renderHtml({
    lastTue: fm.LastAkaTuesday,
    lastThu: fm.LastAkaThursday,
    status: {
